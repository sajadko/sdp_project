...
use App\Http\Livewire\EndPurchaseComponent;
...
Route::get('/end-purchase', EndPurchaseComponent::class)->name('endpurchase');
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/user/password', UserChangePasswordComponent::class)->name('user.password');
